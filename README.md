...
(put a cool picture here)

since this layout isn't present in QMK, this repo contains the keyboard.json files that can be used to add this layout. it's called `LAYOUT_planck_widemods`. you can replace the keyboard.json file in your own local qmk_firmware with this one, change your keymap to use this layout and add a bottom row with 9 keys.
